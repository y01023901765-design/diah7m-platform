...
export default 
{
  ...
  overview:'📊 종합 진단',
  gaugeTab:'📋 59게이지',
  satCrossTitle:'위성 교차검증',satCrossDesc:'경제지표와 위성 데이터의 상관관계를 검증합니다',satCompareTitle:'위성 촬영 비교',satS2Name:'야간광량',satR6Name:'도시열섬',satStatus:'위성 현황',satTab:'🛰️ 위성',
  alertTab:'🔔 경보',
  good:'양호',
  caution:'주의',
  alert:'경보',
  ...
  cmLayerCity:'도시 야간광',cmLayerStock:'주식 시설',cmLayerPort:'항만·공항',cmLayerIndustry:'산업단지',cmCities:'개 도시',cmFacilities:'개 시설',cmPortsAir:'개 항만·공항',cmZones:'개 산업단지',cmCityComingSoon:'도시별 상세 준비 중',cmSelectLayer:'레이어를 선택하세요',cmWorldRank:'세계',svStatusNormal:'정상',svStatusWarning:'이상감지',svStatusCollecting:'수집중',svStatusConstruction:'건설중',svDelayed:'15분 지연',gCityMap:'도시 야간광',gBackWorld:'세계지도',err404Title:'위성 신호를 찾을 수 없습니다',err404Desc:'요청하신 페이지가 존재하지 않습니다. 주소를 확인하거나 아래 버튼으로 이동하세요.',err404Home:'홈으로',err404Dash:'대시보드',markAllRead:'모두 읽음',filterAll:'전체',usageStats:'이번 달 사용 현황',usReport:'리포트 조회',usGauge:'게이지 확인',usSatView:'위성 데이터 열람',landNewDesc:'실적 발표 전 공장 가동 직접 관측. 물리 데이터 기반. 선행적. 객관적. 측정이지 의견이 아닙니다.',
