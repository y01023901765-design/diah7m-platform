...
function generateNarrative(result, rawData, meta) {
  ...
  // ── 출처 테이블 (고정 구조) ──
  const sources = [
    { code: "I1",  data: "경상수지",     source: "ECOS", org: "한국은행",   period: "" },
    { code: "I3",  data: "외환보유고",   source: "ECOS", org: "한국은행",   period: "" },
    { code: "I4",  data: "환율",         source: "ECOS", org: "한국은행",   period: "" },
    { code: "I6",  data: "국채금리",     source: "ECOS", org: "한국은행",   period: "" },
    { code: "O2",  data: "소비자물가",   source: "KOSIS", org: "통계청",    period: "" },
    { code: "O4",  data: "주가(KOSPI)",  source: "KRX",  org: "한국거래소", period: "" },
    { code: "O6",  data: "소매판매",     source: "KOSIS", org: "통계청",    period: "" },
    // 축2 무역/제조업 출처
    { code: "T5",  data: "선박 입출항",   source: "AIS",   org: "UN Global Platform", period: "" },
    { code: "G6",  data: "야간광량",     source: "VIIRS", org: "NOAA",      period: "" },
    { code: "S3",  data: "NO₂ 농도",    source: "GEMS",  org: "환경위성",   period: "" },
    { code: "T6",  data: "컨테이너 TEU", source: "해수부", org: "해양수산부",  period: "" },
    { code: "T2",  data: "제조업 BSI",   source: "ECOS",  org: "한국은행",   period: "" },
    { code: "R1",  data: "산업용 전력",   source: "전력거래소", org: "전력거래소", period: "" },
    // 축3 골목시장 출처
    { code: "C1",  data: "개폐업 현황",   source: "상가DB",    org: "소상공인진흥공단", period: "" },
    { code: "C2",  data: "유동인구",      source: "열린데이터", org: "서울시",         period: "" },
    { code: "C3",  data: "카드매출",      source: "로컬데이터", org: "행안부",         period: "" },
    { code: "C4",  data: "상가 임대차",   source: "실거래가",   org: "국토부",         period: "" },
    { code: "C5",  data: "상권 등급",     source: "상권정보",   org: "소진공",         period: "" },
    // 축4 부동산 출처
    { code: "M1",  data: "아파트 실거래가", source: "실거래가",   org: "국토부",         period: "" },
    { code: "M2",  data: "미분양 통계",    source: "실거래가",   org: "국토부",         period: "" },
    { code: "M3",  data: "전세가율",       source: "KB부동산",   org: "KB",            period: "" },
    { code: "O5",  data: "경매 건수",      source: "경매정보",   org: "대법원",         period: "" },
    { code: "R5",  data: "건물 높이(SAR)", source: "Sentinel-1", org: "ESA/Copernicus", period: "" },
    { code: "R6",  data: "야간광(신축)",   source: "VIIRS",      org: "NOAA",          period: "" },
    { code: "R5",  data: "주차장 점유",    source: "Sentinel-2", org: "ESA/Copernicus", period: "" },
    { code: "R6",  data: "건물 표면온도",  source: "Landsat",    org: "USGS/NASA",     period: "" },
    { code: "DIAH", data: "괴리 경보",     source: "자체엔진",   org: "DIAH-7M",       period: "" },
    // 축5 고용/가계 출처
    { code: "L1",  data: "고용동향",       source: "KOSIS",     org: "통계청",         period: "" },
    { code: "L2",  data: "실업급여",       source: "고용부",    org: "고용노동부",     period: "" },
    { code: "L3",  data: "가계부채",       source: "ECOS",      org: "한국은행",       period: "" },
    { code: "L4",  data: "연체율",         source: "금감원",    org: "금융감독원",     period: "" },
    { code: "S5",  data: "체감경기 CSI",   source: "ECOS",      org: "한국은행",       period: "" },
    // 축6 지역균형 출처
    { code: "D3",  data: "지방소멸지수",   source: "소멸지수",  org: "한국고용정보원",  period: "" },
    { code: "G1",  data: "지역별 GRDP",   source: "KOSIS",     org: "통계청",         period: "" },
    { code: "D2",  data: "지역별 인구이동", source: "전입전출",  org: "통계청",         period: "" },
    { code: "C5",  data: "지역별 창폐업",  source: "상가정보",  org: "소진공",         period: "" },
    { code: "G1",  data: "지방재정자립도", source: "지방재정365", org: "행안부",        period: "" },
    { code: "G6",  data: "지역별 야간광",  source: "VIIRS",     org: "NOAA",          period: "" },
    { code: "R1",  data: "특구 투자유치",  source: "산업부",    org: "산업통상자원부",  period: "" },
    // 축7 금융 스트레스 출처
    { code: "F3",  data: "회사채 스프레드", source: "금투협",    org: "금융투자협회",    period: "" },
    { code: "F5",  data: "CP 금리",        source: "ECOS",      org: "한국은행",       period: "" },
    { code: "F6",  data: "은행 BIS 비율",  source: "금감원",    org: "금융감독원",     period: "" },
    { code: "F1",  data: "코스피 변동성",  source: "KRX",       org: "한국거래소",     period: "" },
    { code: "F2",  data: "은행채 스프레드", source: "금투협",    org: "금융투자협회",    period: "" },
    // 축8 에너지/자원 출처
    { code: "P3",  data: "유가 Dubai",     source: "Opinet",    org: "한국석유공사",    period: "" },
    { code: "P4",  data: "전력 예비율",    source: "전력거래소",  org: "전력거래소",     period: "" },
    { code: "P5",  data: "LNG 재고",      source: "가스공사",    org: "한국가스공사",    period: "" },
    { code: "R1",  data: "산업용 전력",    source: "전력거래소",  org: "전력거래소",     period: "" },
    { code: "P6",  data: "원자재 가격지수", source: "ECOS",      org: "한국은행",       period: "" },
    // 축9 인구/노화 출처
    { code: "D1",  data: "합계출산율",     source: "KOSIS",     org: "통계청",         period: "" },
    { code: "D2",  data: "고령화율",       source: "KOSIS",     org: "통계청",         period: "" },
    { code: "D3",  data: "생산가능인구",   source: "KOSIS",     org: "통계청",         period: "" },
    { code: "D3",  data: "학령인구",       source: "교육부",    org: "교육부",         period: "" },
    { code: "D2",  data: "이민 순유입",    source: "법무부",    org: "법무부",         period: "" },
  ];
