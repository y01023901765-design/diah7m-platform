...
const APPENDIX = [
  ...
  { title: "5. 핵심 등식 — 칼슘·부채·인플레이션의 구분", text: "칼슘=전기=현금=유동성. 뼈=배터리=비상금고(칼슘 99% 저장). 대출은 뼈에서 칼슘이 유출되는 것이고, 이자는 그 유출된 칼슘이 좁아진 길목에 굳어 미세석회로 침착되는 것이다. 미세석회(부채)와 CO₂(인플레이션 압력)는 성격이 다르다. 부채는 굳어서 막는 구조적 문제이고, 인플레이션은 운영 중 생기는 기체성 압력이다. 둘을 혼동하면 처방이 틀린다." },
